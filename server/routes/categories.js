  ...
  categories
    ...
    .then(function (categories) {
      ...
      products
        ...
        .catch(function (err) {
          console.log(
            "categories.js - getProductsInCategory (line 9) error:",
    ...
    .catch(function (err) {
      console.log(
        "categories.js - getCategories (line 7) error:",
        JSON.stringify(err, null, 2)
      );
      next();
    });
  ...
  categories
    ...
    .then(function (categoryCollection) {
      ...
      products
        ...
        .catch(function (err) {
          console.log(
            "categories.js - getProducts (line 25) error:",
            JSON.stringify(err, null, 2)
          );
          next();
        });
    ...
    .catch(function (err) {
      console.log(
        "categories.js - getCategories (line 23) error:",
        JSON.stringify(err, null, 2)
      );
      next();
    });
