...
function Startup({
  ...
  return (
    <Wrapper fade={fade ? 1 : 0}>
      ...
      <DemoText>
        This is a demo, <b>so everything you make here will not be saved.</b> If
        you decide you want to use Dev Notes for yourself, you'll set it up with{" "}
        <a href="https://www.contentful.com/" target="__blank" rel="noreferrer">
          Contentful
        </a>
